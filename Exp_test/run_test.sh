...
# echo "IPW running..."
# rank_json_file=/home/zeyuzhang/LearningtoRank/codebase/myLTR/Exp_test/ranker_json/IPW.json
...
mkdir -p $output_fold/results/SAC_CQL_LSTM_1e-4
python ./runs/run_SAC_CQL.py --output_fold $output_fold/results/SAC_CQL_LSTM_1e-4 \
    --ranker_json_file $rank_json_file \
    --running_json_file $running_json_file \
    --start_epoch $start_epoch \
    --test_only 
...
# rank_json_file=/home/zeyuzhang/LearningtoRank/codebase/myLTR/Exp_test/ranker_json/DQN_CQL_LSTM.json
