...
do
    ...
    CUDA_VISIBLE_DEVICES=1 python runs/run_DLA.py --dataset_fold $dataset_fold --output_fold $output_fold --click_type $clt --feature_size $feature_size
done
