# run dla on mq
output_fold=./run_demo  # switch to your 
...
# running_json_file=$output_fold/run_json/run_mq_rand.json
# rank_json_file=D:/Projects/myLTR/run_demo/ranker_json/DLA.json
# mkdir -p $output_fold/results_rand/DLA
# python ./runs/run_DLA.py --output_fold $output_fold/results_rand/DLA \
#     --ranker_json_file $rank_json_file \
#     --running_json_file $running_json_file \
#     --start_epoch $start_epoch \
#     # --test_only 
...
mkdir -p $output_fold/results_svm/SAC_CQL_$embed_type
python ./runs/run_SAC_CQL.py --output_fold $output_fold/results_svm/SAC_CQL_$embed_type\
    --ranker_json_file $rank_json_file \
    --running_json_file $running_json_file \
    --start_epoch $start_epoch
python ./runs/run_SAC_CQL.py --output_fold $output_fold/results_svm/SAC_CQL_$embed_type\
...
# rank_json_file=D:/Projects/myLTR/run_demo/ranker_json/DQN_CQL_LSTM.json
